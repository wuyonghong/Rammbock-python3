...
class TestTBCDContainerTemplate(TestCase):
    ...
    def test_get_binlength_for_odd_value_tbcd_container(self):
        ...
        self.assertEqual(8, container.binlength)
        container = TBCDContainerTemplate('tbcd', None)
        container.add(TBCD('3', 'first', '123'))
        self.assertEqual(16, container.binlength)
    ...
    def test_decode(self):
        ...
        self.assertEqual('123', decoded.first.tbcd)
    ...
    def test_get_encoded_raw_bytes(self):
        ...
        self.assertEqual(to_bin("0b0010000101100011000000010000000000000000000000000000000000010000"), encoded._get_raw_bytes())
    ...
    def test_decode_raw_bytes_with_star_length(self):
        ...
        self.assertEqual('123', decoded.first.tbcd)
        self.assertEqual('6100000000001', decoded.second.tbcd)
